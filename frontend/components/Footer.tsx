  ...
  return (
    <footer className="border-t border-gray-200 bg-white dark:bg-gray-900 dark:border-gray-800">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="flex flex-col">
            <div className="flex items-center mb-4">
              ...
              <h3 className={twMerge("ml-2 text-lg font-bold text-blue-600", calsans.className)}>
                Investora
              </h3>
            </div>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              Empowering e-commerce merchants with strategic visibility solutions that drive growth and success.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/tracing-demo" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  About Us
                </Link>
              </li>
              <li>
        ...
        {/* Bottom Section */}
        <div className="border-t border-gray-200 dark:border-gray-800 mt-12 pt-8 flex flex-col items-center">
          <p className="text-xs text-gray-500 dark:text-gray-400 text-center">
            © {currentYear} Investora. All rights reserved.
          </p>
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-2 text-center">
            Designed with ♥ for e-commerce growth
          </p>
        </div>
      </div>
    </footer>
